                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="default" class="col-sm-2 control-label">Enter Event
                                                    name:</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
                                                <label for="default" class="col-sm-2 control-label">Event
                                                    Description:</label>
                                                <div class="col-sm-10">
                                ...
                                if ($i % 2 == 0) {
                                    ?>
                                        <tr> <?php
                                            ...
                                            <td>
                                                <div class="content">Event Name: <?php echo @$row['name']; ?>
                                                </div>
                                                <div class="content">Event Description:<?php echo @$row['des']; ?>
                                                </div>
                                                <div style="margin-top:5px; color:red;"><a
                                                        href="add-event.php?del_id=<?php echo $row['id']; ?>"
                                                        style="height:30px; width:30px;"
                                                        name="<?php echo $row['id']; ?>"><img
                                                            src="images\trash.png" style="width:30px ; height:30px;">
                                                        Remove </a>
                                                    <a href="update-event-action.php?chn_id=<?php echo $row['id']; ?>"
                                                        style="height:30px; width:30px;"
