		...
		<table align="center">
			...
			<td>
				<div><img
						...
						width="180" height="170"></div>
			</td>
			<td style="vertical-align: middle;">
				<div class="content" style="font-size:22">Event Name: <?php echo @$row['name']; ?>
				</div>
				<div class="content" style="font-size:22">Event Description:<?php echo @$row['des']; ?>
				</div>
			</td>
			<tr>
