...
while ($row = mysqli_fetch_assoc($r)) { ?>
                ...
                <tr align="center">
                    <td><?php echo @$row['shape']; ?>
                    </td>
                    <td>$<?php echo @$row['price']; ?>
                    </td>
                    <td><?php echo @$row['carat']; ?>
                    </td>
                    <td><?php echo @$row['cut']; ?>
                    </td>
                    <td><?php echo @$row['color']; ?>
                    </td>
                    <td><?php echo @$row['clarity']; ?>
                    </td>

                    <td><a
                            href="viewproduct.php?id=<?php echo $row['id']; ?>"><i
                                class="fa fa-eye" title="Edit Record"></i> </a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
...

        {
            ...
            $("#rangeslider2").slider({
                ...
                slide: function(event, ui) {
                    ...
                    $("#rangevalue2").val("Min: " + arrCodes[ui.values[0]] + " - Max: " + arrCodes[ui
                        .values[1]]);
                }
            });

            $('#rangevalue2').val(arrCodes[$("#rangeslider2").slider("values", 0)] + " - " + arrCodes[$("#slider-range")
                .slider("values", 1)]);
        } {
            var arrCodes = [
                1, 2, 3, 4, 5, 6, 7
            ...
            $("#rangeslider3").slider({
                ...
                slide: function(event, ui) {
                    ...
                    $("#rangevalue3").val("Min: " + arrCodes[ui.values[0]] + " - Max: " + arrCodes[ui
                        .values[1]]);

                }
            });

            $('#rangevalue3').val(arrCodes[$("#rangeslider3").slider("values", 0)] + " - " + arrCodes[$("#slider-range")
                .slider("values", 1)]);
