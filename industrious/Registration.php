...
<head>
  ...
  <script src="sweetAlert\src\sweetalert2.js"></script>
  <link rel="stylesheet" href="sweetAlert\src\sweetalert2.min.css">
</head>
<?php
...
if (isset($_POST['submit'])) {
    ...
    if ($num > 0) {
        ...
        // Email subject
        $mail->Subject = 'Send Email via Amrut Export';
...
<?php
       ...
       // $a = mysqli_query($con, "INSERT INTO registration(company,contact_person,address,city,state,zip,email,password,feedback) VALUES('$company','$contact_person','$address','$city','$state','$$zip','$email','$password','$feedback') ");
...
<center>
  <p style="color:#F00;"><?php if (@$wrong_otp) {
    echo $wrong_otp;
} ?>
  </p>
</center>
<center>
  <p style="color:#F00;"><?php if (@$msg) {
    echo $msg;
}?>
  </p>
</center>
      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="fname" name="company"
              value="<?php echo $company; ?>"
              placeholder="Enter company name" pattern="[a-zA-Z]+" required>
            <label for="fname"><i class="fa fa-user"></i>Contact Person</label>
            <input type="text" id="fname" name="contact_person"
